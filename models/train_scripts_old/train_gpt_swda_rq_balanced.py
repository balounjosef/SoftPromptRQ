...
# basic settings
modelidentifier = "gpt2_10_swda_rq_balanced_fulltrain_adamW"
gpt2id = "gpt2"
device = None
batch = 64
epochs = 200
...
# Init folder
modeldir = f"{__file__[:-len('models/train_scripts/train_gpt_swda_rq.py')]}bin/{modelidentifier}_lr{learning_rate}_batch{batch}"
...
input_length = 60
# Prepare data
train_dataset = SwDA_RQDataset_Balanced("train1_balanced", gpt2id, input_length=input_length)
val_dataset = SwDA_RQDataset_Balanced("validate1_balanced", gpt2id, input_length=input_length)
test_dataset = SwDA_RQDataset_Balanced("test_balanced", gpt2id, input_length=input_length)
