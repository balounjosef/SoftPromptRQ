...
from dataset.swda_rq_dataset import SwDA_RQDataset
...
input_length = 60
# Prepare data
train_dataset = SwDA_RQDataset("train1", gpt2id, input_length=input_length)
val_dataset = SwDA_RQDataset("validate1", gpt2id, input_length=input_length)
test_dataset = SwDA_RQDataset("test", gpt2id, input_length=input_length)
