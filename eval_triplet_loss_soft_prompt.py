...
# model.load_learnable_params(paths.bin + "TripletMultiDataset/bert-base-cased_eucSM_out32_margin0.5_sc1_prompts10_inp118_lr0.0002_batch64/model_best_val_acc.cp")
# model.load_learnable_params(paths.bin + "TripletMultiDataset/bert-base-cased_eucMSE_out32_sc1_prompts10_inp118_lr0.0002_batch64/model_best_val_acc.cp")
# model.load_learnable_params(paths.bin + "TripletMultiDataset/bert-base-cased_out32_margin0.5e0.25_sc1_cosEucSM_prompts10_inp118_lr0.0002_batch64/model_best_val_acc.cp")
# model.load_learnable_params(paths.bin + "TripletMultiDataset/bert-base-cased_outNone_margin0.5_sc1_prompts10_inp118_lr0.0002_batch64/model_best_val_acc.cp")
# model.load_learnable_params(paths.bin + "TripletMultiDataset/bert-base-cased_out32_margin0.5_sc1_nobias_prompts10_inp118_lr0.0002_batch64/model_best_val_acc.cp")
# model.load_learnable_params(paths.bin + "TripletMultiDataset/bert-base-cased_out32_margin0.5_MRDA_prompts10_inp118_lr0.0002_batch64/model_best_val_acc.cp")
model.load_learnable_params(paths.bin + "TripletDataset/bert-base-cased_out32_margin0.5_fine_tuning_swda_prompts10_inp118(118)_lr0.0002_batch32/model_best_val_acc.cp")
# model.load_learnable_params(paths.bin + "TripletMultiDataset/xxxxxxxxxx/model_best_val_acc.cp")
...
base_model_path = paths.bin + "TripletDataset/bert-base-cased_out32_margin0.5_fine_tuning_swda_shotsN_seedM_prompts10_inp118(118)_lr0.0002_batch32/model_best_val_acc.cp"
